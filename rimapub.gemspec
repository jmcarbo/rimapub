...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-01-19}
  s.default_executable = %q{rimapub}
  ...
  s.email = ["FIXME email"]
  s.executables = ["rimapub"]
  s.extra_rdoc_files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "website/index.txt"]
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "Rakefile", "bin/rimapub", "config/website.yml.sample", "lib/rimapub.rb", "lib/rimapub/rimapub.rb", "lib/rimapub/rimapub_service.rb", "lib/rimapub/rimapub_set.rb", "script/console", "script/destroy", "script/generate", "script/txt2html", "spec/rimapub_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "tasks/rspec.rake", "website/index.html", "website/index.txt", "website/javascripts/rounded_corners_lite.inc.js", "website/stylesheets/screen.css", "website/template.html.erb"]
  s.has_rdoc = true
